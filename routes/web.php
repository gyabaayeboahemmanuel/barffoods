...
// Wishlist page (public – guests use localStorage; logged-in users use API)
...
// Checkout: GET is public (guests see sign-in/sign-up form; auth users see full checkout)
